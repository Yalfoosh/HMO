...
INSTANCE_PATH="data/HMO_2020-21_midterm-task_instance-1.tsv"
SOLUTION_PATH="data/greedy-search/dump-1.tsv"
DUMP_PATH="data/local-search/dump-1.tsv"
SOLUTION_DUMP_PATH="data/local-search/solution-1.txt"
...
python3 src/local_search.py --instance_path $INSTANCE_PATH \
