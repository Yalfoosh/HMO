...
def get_parser():
    ...
    path_group.add_argument(
        ...
        type=str,
        metavar="PATH",
        default="data/local-search/dump.json",
        help=(
            "A path to the JSON dump file with the results. Defaults to "
            "data/local-search/dump.json."
        ),
    )
    ...
    path_group.add_argument(
        ...
        type=str,
        metavar="PATH",
        default="data/local-search/solution.txt",
        help=(
            "A path to the dump file with the results. Defaults to "
            "data/local-search/solution.txt."
        ),
    )
